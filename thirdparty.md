...
- [Jekyll](https://jekyllrb.com/) - [Version 4.2.1](https://github.com/jekyll/jekyll/releases/tag/v4.2.1)
...
- [Font Awesome](https://fontawesome.com/) - [Version 5.15.4](https://use.fontawesome.com/releases/v5.15.4/css/all.css)
